...
public static String codigo1;
    ...
    public void buscartablaStock(JTable tbproducto) {
        tbproducto.setDefaultRenderer(Object.class, new Render());
        tbproducto.setDefaultRenderer(Object.class, new Render());
        DefaultTableModel modelo = new DefaultTableModel(){
            @Override
        ...
        if(list.size() > 0){
            for(int i=0; i<list.size(); i++){
                ...
                try{
                    ...
                    InputStream in = new ByteArrayInputStream(bi);
                    image = ImageIO.read(in);
                    ImageIcon imgi = new ImageIcon(image.getScaledInstance(150, 100, 0));
                    datos[11] = new JLabel(imgi);
            ...
            tbproducto.setModel(modelo);
            tbproducto.setRowHeight(150);
        }
    }

    public void vizualizartablaStock(JTable tbproducto) {
        tbproducto.setDefaultRenderer(Object.class, new Render());
        tbproducto.setDefaultRenderer(Object.class, new Render());
        DefaultTableModel modelo = new DefaultTableModel(){
            @Override
